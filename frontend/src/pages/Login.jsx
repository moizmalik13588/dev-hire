  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 flex flex-col lg:flex-row">
      <div className="hidden lg:flex lg:w-1/2 bg-blue-700 dark:bg-blue-900 flex-col justify-center px-16">
        ...
        <h2 className="text-4xl font-bold text-white leading-tight mb-4">Find your next great opportunity</h2>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" value={form.email}
                  ...
                  className="w-full pl-10 pr-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-200"
